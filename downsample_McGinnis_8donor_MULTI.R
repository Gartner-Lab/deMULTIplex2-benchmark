...
savePath <- "./data-raw/benchmark_res/ds_McGinnis_8donor_MULTI/"; dir.create(savePath)
rdsPath <- paste0(savePath, "rds/");dir.create(rdsPath)
plotPath <- paste0(savePath, "plots/"); dir.create(plotPath)

test_text <- "ds_McGinnis_8donor_MULTI_"


rna_mtx <- readRDS(paste0("./data-raw/benchmark_res/McGinnis_8donor_MULTI/rds/",  "McGinnis_8donor_MULTI_benchmarking_", "rna_mtx.rds"))
tag_mtx <- readRDS(paste0("./data-raw/benchmark_res/McGinnis_8donor_MULTI/rds/", "McGinnis_8donor_MULTI_benchmarking_", "tag_mtx.rds"))
true_label <- readRDS(paste0("./data-raw/benchmark_res/McGinnis_8donor_MULTI/rds/",  "McGinnis_8donor_MULTI_benchmarking_", "true_label.rds"))
tag_mapping <- readRDS(paste0("./data-raw/benchmark_res/McGinnis_8donor_MULTI/rds/",  "McGinnis_8donor_MULTI_benchmarking_", "tag_mapping.rds"))
...
test_text <- paste0("ds_McGinnis_8donor_MULTI_",cur_ratio)
...
bc_res <- lapply(show_ratios, function(cur_ratio) {
    if(cur_ratio == 1) {
        res = readRDS(paste0("./data-raw/benchmark_res/McGinnis_8donor_MULTI/rds/", "McGinnis_8donor_MULTI_benchmarking_bc_all.rds"))
        res$demuxEM <- NULL
    } else {
        res = readRDS(paste0(rdsPath, paste0("ds_McGinnis_8donor_MULTI_",cur_ratio), "bc_all.rds"))
    }
    return(res)
})
